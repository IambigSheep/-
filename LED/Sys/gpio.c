...
void GPIO_Pwm_Pin_Config(void)		//特殊IO口配置
{
	...
	GPIO_InitStructure.Mode = GPIO_OUT_PP;		//模式配置
	GPIO_InitStructure.Pin	= GPIO_Pin_6 | GPIO_Pin_7;	//引脚设置
	GPIO_Config(GPIO_P0, &GPIO_InitStructure);
	...
	GPIO_Config(GPIO_P2,&GPIO_InitStructure);
	
	GPIO_InitStructure.Mode = GPIO_OUT_PP;
	GPIO_InitStructure.Pin = 0;
	GPIO_InitStructure.Pin	= GPIO_Pin_7 ;
	GPIO_Config(GPIO_P3,&GPIO_InitStructure);
	
	GPIO_InitStructure.Mode = GPIO_OUT_PP;
	GPIO_InitStructure.Pin = 0;
	GPIO_InitStructure.Pin	= GPIO_Pin_2 | GPIO_Pin_4 | GPIO_Pin_5 ;
	GPIO_Config(GPIO_P4,&GPIO_InitStructure);
}
